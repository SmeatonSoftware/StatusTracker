    ...
    render() {
        return <View style={styles.body}>
            <Padd style={{alignItems: "center", minWidth: "100%"}}>
                ...
                <TextInput style={styles.input} value={this.state.newUrl}
                           onChangeText={x => this.setState({newUrl: x})}/>
            </Padd>
            <Padd style={{alignItems: "center", minWidth: "100%"}}>
                <Text style={styles.text}>Minutes between ping</Text>
                <TextInput style={styles.input} value={this.state.minutes}
                           onChangeText={x => this.setState({minutes: x})}/>
            </Padd>
            <Padd style={{
                paddingTop: 10,
                paddingBottom: 10,
